...
<section class="position-relative pt-sm-8 pt-lg-9 pb-4">
	...
	<div class="position-absolute top-0 end-0 z-index-2 d-none d-md-block rtl-flip">
		<img src="com_assets/images/elements/grad-shape/07.png" alt="">
	</div>
			...
			<div class="d-flex gap-3 gap-sm-4 flex-wrap">
				...
				<div class="d-flex gap-2 align-items-center">
					<ul class="avatar-group mb-0 align-items-center">
						<li class="avatar">
							<img class="avatar-img rounded-circle" src="com_assets/images/avatar/02.jpg" alt="avatar">
						</li>
						<li class="avatar">
							<img class="avatar-img rounded-circle" src="com_assets/images/avatar/05.jpg" alt="avatar">
						</li>
						<li class="avatar">
...
<section class="bg-secondary position-relative overflow-hidden">
	...
	<div class="container position-relative z-index-9">
		...
		<div class="position-absolute top-0 start-50 translate-middle-x mt-n3">
			<img src="com_assets/images/elements/grad-shape/blur-decoration-2.svg" class="opacity-2 blur-8" alt="Grad shape">
		</div>
			...
			<div class="row rounded-4 overflow-hidden g-0">
				...
				<div class="col-sm-5">
					<div class="card card-body p-0 h-100">
						<!-- Image -->
						<img src="com_assets/images/bg/02.jpg" alt="">
				...
				<!-- Code image -->
				<div class="col-sm-7">
					<div class="h-100" style="background:url(com_assets/images/bg/code.jpg) no-repeat; background-size:cover; background-position:left top;"></div>
				</div>
			</div>
		</div>
		...
		"slidesPerView": 2, 
			...
			<div class="swiper-wrapper align-items-center">
				...
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/01.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/01.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/01.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/02.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/02.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/02.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/03.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/03.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/03.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/04.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/04.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/04.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/05.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/05.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/05.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/06.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/06.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/06.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/07.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/07.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/07.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/08.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/08.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/08.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
				<!-- Image -->
				<div class="swiper-slide">
					<div class="swap-logo">
						<img src="com_assets/images/client/logo-gray/09.svg" alt="client-img">
						<div class="swap-item">
							<img src="com_assets/images/client/logo-light/09.svg" class="dark-mode-item" alt="client logo">
							<img src="com_assets/images/client/logo-dark/09.svg" class="light-mode-item" alt="client logo">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row g-4">
			...
			<div class="col-lg-6 position-relative ms-auto ps-lg-4">
				...
				<div class="position-absolute start-0 bottom-0 ms-n6 mb-5 d-none d-sm-block">
					<img src="com_assets/images/elements/grad-shape/08.png" class="blur-1 z-index-9 position-relative" alt="shape decoration">
				</div>

				<!-- Blur decoration -->
				<div class="position-absolute top-50 start-0 translate-middle-y ms-n4 mt-n7">
					<img src="com_assets/images/elements/grad-shape/blur-decoration.svg" class="blur-7 opacity-1" alt="Grad shape">
				</div>

				<!-- Main image -->
				<img src="com_assets/images/about/04.jpg" class="rounded-4 position-relative z-index-2" alt="about image">
			</div>
...
<section class="bg-body position-relative overflow-hidden">
	...
	<div class="bg-dark h-500px w-100 position-absolute top-0 start-0">
		...
		<div class="position-absolute top-0 start-0 translate-middle">
			<img src="com_assets/images/elements/grad-shape/blur-decoration-2.svg" class="opacity-1 blur-8" alt="Grad shape">
		</div>
	...
	<div class="container position-relative">
		...
		<!-- Video section -->
		<div class="bg-parallax position-relative h-400px h-xl-500px rounded-4 overflow-hidden" style="background:url(com_assets/images/about/05.jpg) no-repeat; background-size:cover; background-position:center;">
			<!-- BG overlay -->
		...
		<div class="inner-container-small bg-body shadow-primary rounded-3 text-center py-3 mt-5">
			<p class="mb-0 px-2 px-sm-5 px-md-0">🚀 Need any help or questions, don't worry! 
				<a href="contact-us-v2.html" class="fw-semibold heading-color hover-underline-animation">Hit the button</a>
			</p>
		</div>
	</div>
</section>
...
<section class="bg-body position-relative pt-0 pb-5 pb-sm-0">
	...
	<div class="position-absolute top-100 start-0 translate-middle z-index-2 ms-5 ms-xl-9 mt-5 d-none d-sm-block">
		<img src="com_assets/images/elements/grad-shape/10.png" class="h-500px h-xl-700px rtl-flip" alt="">
	</div>
			...
			<div class="col-xl-6">
				<div class="card bg-primary h-100">
					...
					<!-- Rocket image -->
						...
						<img src="com_assets/images/elements/rocket-02.png" alt="rocket image">
						</div>
			...
			<div class="col-xl-6">
				<div class="card bg-primary-grad h-100 overflow-hidden">
					...
					<div class="position-absolute end-0 top-0 me-n8 d-none d-sm-block">
						<img src="com_assets/images/elements/person-laptop.png" alt="">
					</div>
					...
					<div class="row align-items-center p-3 p-sm-4">
						...
						<div class="col-sm-8">
							<div class="card-body text-white">
								...
								<a class="btn btn-sm btn-dark icon-link icon-link-hover" href="career.html">View open positions<i class="bi bi-arrow-right"></i> </a>
