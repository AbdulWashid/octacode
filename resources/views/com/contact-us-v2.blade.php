...
<!-- =======================
Hero START -->
<section class="position-relative py-xl-9" style="background:url(com_assets/images/bg/contact.jpg) no-repeat; background-size:cover; background-position:center;">
	<!-- Bg overlay -->
				...
				<div class="card card-body bg-secondary bg-opacity-50 rounded-4 p-4 p-sm-5 mb-4">
					...
					<div class="d-sm-flex gap-3 mb-4">
						...
						<div class="mt-3 mt-sm-0">
							...
							<ul class="list-inline d-flex flex-wrap gap-sm-3 mb-0">
								<li class="list-inline-item"> <a href="#" class="fw-semibold heading-color text-primary-hover">+(251) 854-6308</a></li>
					...
					<div class="d-sm-flex gap-3 mb-4">
						...
						<div class="mt-3 mt-sm-0">
							...
							<a href="#" class="fw-semibold heading-color text-primary-hover mb-0">example@gmail.com</a>
						</div>
					</div>
