...
<section class="bg-dark position-relative pt-xl-8 pb-0 overflow-hidden">
	...
	<div class="position-absolute top-0 start-0 mt-n9 ms-n5">
		<img src="com_assets/images/elements/grad-shape/blur-decoration.svg" class="blur-7 opacity-2" alt="Grad shape">
	</div>

	<!-- Grad blur -->
	<div class="position-absolute top-0 start-50 mt-n9 ms-n9">
		<img src="com_assets/images/elements/grad-shape/blur-decoration.svg" class="blur-8 opacity-1" alt="Grad shape">
	</div>
	<!-- Decoration START -->
	...
	<div class="container position-relative pt-4 pt-sm-5" data-bs-theme="dark">
		<div class="row">
			...
			<div class="col-md-7 col-lg-5 text-center text-md-start">
				...
				<!-- Button -->
				<a href="contact-us-v1.html" class="btn btn-white mb-0"><i class="bi bi-telephone me-2"></i>Contact our experts</a>
			</div>

			<!-- Image -->
			<div class="col-sm-10 col-md-5 ms-auto mt-5 mt-md-0">
				<img src="com_assets/images/elements/service-hero.png" alt="hero image">
			</div>
		</div>
	</div>
...
<section class="position-relative pt-6 pt-xxl-0">
	<div class="container">
		<div class="row g-4 g-lg-5">
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/development.png" class="h-70px" alt="icon">
					</div>
					...
					<div class="hover-content d-flex justify-content-center align-items-center position-absolute top-50 start-50 translate-middle">
						<a class="btn btn-white icon-link icon-link-hover mb-0 stretched-link" href="service-single.html">Explore service<i class="bi bi-arrow-right"></i> </a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/marketing.png" class="h-70px" alt="icon">
					</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/brand.png" class="h-70px" alt="icon">
					</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/database.png" class="h-70px" alt="icon">
					</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/consulting.png" class="h-70px" alt="icon">
					</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card card-bg-grad-hover card-content-hover bg-secondary bg-opacity-75 h-100 p-4 p-sm-5">
					...
					<div class="card-header bg-transparent p-0 pb-5">
						<!-- Icon -->
						<img src="com_assets/images/services/3d-icon/app-dev.png" class="h-70px" alt="icon">
					</div>
		...
		<p class="mb-0 mt-5 text-center heading-color">🔥 Let’s create something great work together. 
			<a href="contact-us.html" class="fw-bold hover-underline-animation heading-color">Got a project in mind?</a>
		</p>
	</div>
</section>
<!-- =======================
		...
		<div class="row">
			...
			<div class="col-md-6 position-relative">
				...
				<div class="position-absolute top-0 start-0 ms-xl-5">
					<img src="com_assets/images/elements/rocket-02.png" class="h-150px rotate-335" alt="rocket image">
				</div>

				<div class="row ps-xl-7">
					<!-- Image -->
					<div class="col-sm-8">
						<img src="com_assets/images/about/13.jpg" class="rounded-pill" alt="image">
					</div>
					<!-- Trsutpilot rating -->
					<div class="col-sm-4 col-md-8 col-lg-5 mt-auto ms-lg-n5 mb-5">
						<div class="card shadow rounded text-center p-0">
							...
							<!-- Card footer -->
								...
								<img src="com_assets/images/elements/trustpilot-light.svg" class="h-30px" alt="">
								</div>
						</div>
					</div>
				</div>
...
<section class="bg-secondary-grad position-relative overflow-hidden">
	...
	<div class="position-absolute bottom-0 start-0 mb-n9 d-none d-sm-block">
		<img src="com_assets/images/elements/grad-shape/10.png" class="rotate-270 h-500px h-lg-700px" alt="decoration shape">
	</div>
