	...
	<div class="alert fade show bg-primary border-0 rounded-0 text-center overflow-hidden z-index-9 py-2 m-0 d-none d-lg-block" role="alert">
		<div class="container d-flex justify-content-between px-2 px-xl-4">
			...
			<ul class="list-inline d-flex flex-wrap gap-3 text-white mb-0">
				<li class="list-inline-item small fw-light"><i class="bi bi-headset me-2"></i>Call us: <a href="tel:+91 9876543210" class="link-white">+91 96301 36688 </a></li>
				<li class="list-inline-item small fw-light"><i class="bi bi-envelope me-2"></i>Email: <a href="mailto:example@gmail.com" class="link-white">example@gmail.com</a></li>
			</ul>
								...
								<div class="row px-3 py-4">
									...
									<div class="col-sm-6">
										<ul class="list-unstyled">
											...
											<li> <a class="dropdown-item active" href="index-software-company.html">Software Company</a> </li>
