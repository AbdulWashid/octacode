...
@section('content')
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="com/com_assets/images/favicon.ico">
	...
	<!-- Plugins CSS -->
	<link rel="stylesheet" type="text/css" href="com/com_assets/vendor/bootstrap-icons/bootstrap-icons.css">
	
	<!-- Theme CSS -->
	<link rel="stylesheet" type="text/css" href="com/com_assets/css/style.css">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand me-0" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="com/com_assets/images/logo.svg" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="com/com_assets/images/logo-light.svg" alt="logo">
			</a>
			<!-- Logo END -->
				...
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-size-lg overflow-hidden p-0">
							...
							<!-- Cta -->
							 <div class="h-200px position-relative" style="background:url(com/com_assets/images/elements/nav-cta.jpg) no-repeat; background-size:cover; background-position:center;">
								<!-- Bg overlay -->
...
<section class="bg-secondary-grad position-relative pt-xl-8 overflow-hidden">
	...
	<div class="position-absolute end-0 top-0 rotate-180 mt-n5 me-n9">
		<img src="com/com_assets/images/elements/geo-grad-pattern.svg" class="h-700px opacity-1" alt="bg pattern">
	</div>
	<!-- Patten decoration -->
	<div class="position-absolute start-0 bottom-0 mb-8 ms-n7">
		<img src="com/com_assets/images/elements/geo-grad-pattern.svg" class="h-400px opacity-1" alt="bg pattern">
	</div>

	<!-- Grad blur -->
	<div class="position-absolute top-0 start-50 mt-n9 ms-n9">
		<img src="com/com_assets/images/elements/grad-shape/blur-decoration.svg" class="blur-8 opacity-1" alt="Grad shape">
	</div>
					...
					<div class="col-xl-11">
						<div class="card card-hover-shadow card-hover-transition shadow-primary-sm bg-body bg-opacity-75 bg-blur rounded-4 p-3 p-lg-4">
							<div class="row g-0">
								<div class="col-md-5">
									<!-- Image -->
									<img src="com/com_assets/images/services/4by3/01.jpg" class="card-img mb-3 mb-md-0" alt="...">
								</div>
								<div class="col-md-7">
									<!-- Content -->
					...
					<div class="col-xl-11 ms-auto">
						<div class="card card-hover-shadow card-hover-transition shadow-primary-sm bg-body bg-opacity-75 bg-blur rounded-4 p-3 p-lg-4">
							<div class="row g-0">
								<div class="col-md-5">
									<!-- Image -->
									<img src="com/com_assets/images/services/4by3/02.jpg" class="card-img mb-3 mb-md-0" alt="...">
								</div>
								<div class="col-md-7">
									<!-- Content -->
									<div class="card-body d-flex flex-column h-100 px-2 px-md-4 py-0 py-md-2">
					...
					<div class="col-xl-11">
						<div class="card card-hover-shadow card-hover-transition card-img-scale shadow-primary-sm bg-body bg-opacity-50 bg-blur rounded-4 p-3 p-lg-4">
							<div class="row g-0">
								<div class="col-md-5">
									<!-- Image -->
									<img src="com/com_assets/images/services/4by3/03.jpg" class="card-img mb-3 mb-md-0" alt="...">
								</div>
								<div class="col-md-7">
									<!-- Content -->
									<div class="card-body d-flex flex-column h-100 px-2 px-md-4 py-0 py-md-2">
					...
					<div class="col-xl-11 ms-auto">
						<div class="card card-hover-shadow card-hover-transition shadow-primary-sm bg-body bg-opacity-75 bg-blur rounded-4 p-3 p-lg-4">
							<div class="row g-0">
								<div class="col-md-5">
									<!-- Image -->
									<img src="com/com_assets/images/services/4by3/04.jpg" class="card-img mb-3 mb-md-0" alt="...">
								</div>
								<div class="col-md-7">
									<!-- Content -->
									<div class="card-body d-flex flex-column h-100 px-2 px-md-4 py-0 py-md-2">
	...
	<div class="container">
		<div class="row align-items-center align-items-xl-end">
			...
			<div class="col-md-5 mb-9 mb-md-0">
				...
				<!-- Button -->
				<a class="btn btn-dark icon-link icon-link-hover" href="portfolio-modern.html">Explore our work<i class="bi bi-arrow-right"></i> </a>
			</div>
			<!-- Content END -->
			...
			<div class="col-md-6 ms-auto">
				<div class="bg-secondary bg-opacity-50 rounded-4">
					<img src="com/com_assets/images/elements/service-2.png" class="mt-n8" alt="image">
				</div>
			</div>
		</div>
	</div>
