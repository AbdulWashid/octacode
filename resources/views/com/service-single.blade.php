				...
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-size-lg overflow-hidden p-0">
							...
							<!-- Cta -->
							 <div class="h-200px position-relative" style="background:url(com_assets/images/elements/nav-cta.jpg) no-repeat; background-size:cover; background-position:center;">
								<!-- Bg overlay -->
...
<section class="position-relative pt-8 pt-xl-9 pb-0 overflow-hidden mb-n6">
	...
	<div class="bg-secondary-grad h-500px w-100 position-absolute bottom-0 start-0">
		<!-- Curve decoration -->
		<span>
			<svg class="mt-n2" viewBox="0 0 1950 135" style="enable-background:new 0 0 1950 135;" xml:space="preserve">
				<path class="fill-body" d="M1480.3,110.5c238.7,18.9,359.6-42.2,469.7-80.7V1.7L0,0v129.4c57.3-41.7,287.7-15.9,446.4,0 c170.6,17.1,342.3-15.8,440.8-35.8C1104,49.6,1274.8,94.2,1480.3,110.5z"/>
			</svg>
		</span>
	</div>
	...
	<div class="container position-relative" data-sticky-container>
		<div class="row">
			...
			<div class="col-md-6">
				...
				<!-- Button -->
				<a class="btn btn-dark icon-link icon-link-hover" href="#">Start a project<i class="bi bi-arrow-right"></i> </a>
			...
			<div class="col-md-5 ms-auto">
				<div data-sticky data-margin-top="100" data-sticky-for="576">
					<div class="rounded-4 h-400px h-lg-500px" style="background:url(com_assets/images/services/4by3/03.jpg) no-repeat; background-size:cover; background-position:center;"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container pb-8">
		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-4">
			...
			<div class="col">
				<div class="card card-body h-100 rounded-3 p-4">
					...
					<p class="mb-0">We create tailor-made websites that reflect your brand's identity and engage your audience.</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body h-100 rounded-3 p-4">
					...
					<p class="mb-0">Our solutions are built to grow with your business, ensuring long-term success.</p>
				</div>
			</div>
			...
			<div class="col">
				<div class="card card-body h-100 rounded-3 p-4">
					...
					<p class="mb-0">Our websites are optimized for search engines to help you rank higher and attract more traffic.</p>
				</div>
			</div>
		</div>
		<!-- Benefits END -->
		...
		<div class="row g-4 mt-5 mt-md-7">
			...
			<div class="col-lg-6 pe-lg-6">
				<img src="com_assets/images/services/01.jpg" class="rounded-4" alt="service image">
			</div>
				...
				<div class="accordion accordion-icon accordion-icon-start mt-4" id="accordionExample2">
					...
					<div class="accordion-item mb-2">
						<h6 class="accordion-header" id="heading-1">
							<button class="accordion-button py-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
					...
					<div class="accordion-item mb-2">
						<h6 class="accordion-header" id="heading-2">
							<button class="accordion-button py-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
					...
					<div class="accordion-item mb-2">
						<h6 class="accordion-header" id="heading-3">
							<button class="accordion-button py-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
					...
					<div class="accordion-item mb-2">
						<h6 class="accordion-header" id="heading-4">
							<button class="accordion-button py-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
					...
					<div class="accordion-item mb-2">
						<h6 class="accordion-header" id="heading-5">
							<button class="accordion-button py-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
		...
		<div class="inner-container text-center mt-7">
			...
			<ul class="list-inline d-flex justify-content-center flex-wrap gap-4 mt-4">
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/08.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/04.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/12.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/09.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/05.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/03.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/02.svg" class="h-40px" alt="icon">
					</a>
				</li>
				...
				<li class="list-inline-item me-0">
					<a href="#" class="icon-xl btn-transition bg-body d-flex justify-content-center align-items-center rounded-2">
						<img src="com_assets/images/client/icons/10.svg" class="h-40px" alt="icon">
					</a>
				</li>
			</ul>
		</div>
...
<section class="pt-0 mt-n9">
	<div class="container-fluid position-relative">
		<div class="max-width-1550 bg-dark position-relative rounded-4 overflow-hidden py-5 py-sm-6 py-lg-8" data-bs-theme="dark">
			<div class="container position-relative">
				...
				<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
					...
					<div class="col">
						...
						<p class="mb-0">We begin by understanding your business goals, target audience, and project requirements.</p>
					</div>
					...
					<div class="col">
						...
						<p class="mb-0">Our design team creates wireframes and prototypes based on the project plan.</p>
					</div>
					...
					<div class="col">
						...
						<h6>Development</h6>
						<p class="mb-0">In this phase, our developers bring the design to life using the latest technologies and best practices.</p>
					</div>
					...
					<div class="col">
						...
						<p class="mb-0">Before going live, we conduct thorough testing to identify and fix any issues.</p>
					</div>
				</div>
				<!-- Steps END -->
			</div>
	...
	<div class="container">
		<div class="row g-4">
			...
			<div class="col-lg-4 text-center text-lg-start">
				...
				<!-- Slider button -->
				<div class="d-flex justify-content-center justify-content-lg-start gap-3 position-relative mt-lg-4">
					<a href="#" class="btn btn-secondary btn-lg btn-icon rounded-circle mb-0 swiper-button-prev-team"><i class="bi bi-arrow-left"></i></a>
					<a href="#" class="btn btn-secondary btn-lg btn-icon rounded-circle mb-0 swiper-button-next-team"><i class="bi bi-arrow-right"></i></a>
				</div>
			</div>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="card bg-secondary bg-opacity-50 rounded-4 overflow-hidden mb-3">
								<div class="row g-0">
									<div class="col-md-5">
										<img src="com_assets/images/portfolio/4by4/01.jpg" class="img-fluid rounded-start h-100" alt="...">
									</div>
									<div class="col-md-7">
										<div class="card-body d-flex flex-column align-items-start h-100 p-4">
											<!-- Client logo -->
											<img src="com_assets/images/client/logo-light/01.svg" class="dark-mode-item h-30px mb-3" alt="client logo">
											<img src="com_assets/images/client/logo-dark/01.svg" class="light-mode-item h-30px mb-3" alt="client logo">

											<h6 class="card-title">Corporate website for consulting</h6>
											<p class="card-text">Consulting wanted a professional online presence to attract high-profile clients.</p>
		
											<div class="d-sm-flex justify-content-between align-items-center mt-auto w-100">
												<!-- Progress -->
												...
												<!-- Button -->
												<a href="#" class="btn btn-sm btn-dark stretched-link mb-0">View  detail</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="swiper-slide">
							<div class="card bg-secondary bg-opacity-50 rounded-4 overflow-hidden mb-3">
								<div class="row g-0">
									<div class="col-md-5">
										<img src="com_assets/images/portfolio/4by4/03.jpg" class="img-fluid rounded-start h-100" alt="...">
									</div>
									<div class="col-md-7">
										<div class="card-body d-flex flex-column align-items-start h-100 p-4">
											<!-- Client logo -->
											<img src="com_assets/images/client/logo-light/05.svg" class="dark-mode-item h-30px mb-3" alt="client logo">
											<img src="com_assets/images/client/logo-dark/05.svg" class="light-mode-item h-30px mb-3" alt="client logo">
						...
						<div class="card-footer bg-transparent p-0">
							...
							<div class="d-flex align-items-center">
								<div class="avatar flex-shrink-0">
									<img class="avatar-img rounded-circle" src="com_assets/images/avatar/09.jpg" alt="avatar">
								</div> 
								<div class="ms-3">
				...
				<div class="swiper-slide">
					<div class="card bg-secondary bg-opacity-50 bg-blur rounded-4 p-4 h-100">
						...
						<div class="card-footer bg-transparent p-0">
							...
							<div class="d-flex align-items-center">
								<div class="avatar flex-shrink-0">
									<img class="avatar-img rounded-circle" src="com_assets/images/avatar/10.jpg" alt="avatar">
								</div> 
								<div class="ms-3">
				...
				<div class="swiper-slide">
					<div class="card bg-secondary bg-opacity-50 bg-blur rounded-4 p-4 h-100">
						...
						<div class="card-footer bg-transparent p-0">
							...
							<div class="d-flex align-items-center">
								<div class="avatar flex-shrink-0">
									<img class="avatar-img rounded-circle" src="com_assets/images/avatar/04.jpg" alt="avatar">
								</div> 
								<div class="ms-3">
				...
				<div class="swiper-slide">
					<div class="card bg-secondary bg-opacity-50 bg-blur rounded-4 p-4 h-100">
						...
						<div class="card-footer bg-transparent p-0">
							...
							<div class="d-flex align-items-center">
								<div class="avatar flex-shrink-0">
									<img class="avatar-img rounded-circle" src="com_assets/images/avatar/07.jpg" alt="avatar">
								</div> 
								<div class="ms-3">
				...
				<div class="swiper-slide">
					<div class="card bg-secondary bg-opacity-50 bg-blur rounded-4 p-4 h-100">
						...
						<div class="card-footer bg-transparent p-0">
							...
							<div class="d-flex align-items-center">
								<div class="avatar flex-shrink-0">
									<img class="avatar-img rounded-circle" src="com_assets/images/avatar/01.jpg" alt="avatar">
								</div> 
								<div class="ms-3">
									<p class="lead heading-color fw-semibold mb-0">Emma Watson</p>
									<small>UI/UX designer</small>
				...
				<div class="col-lg-5">
					...
					<div class="row row-cols-1 row-cols-sm-2 g-4 mt-3 mt-md-5">
						...
						<div class="col">
							...
							<a href="#" class="heading-color hover-underline-animation">example@gmail.com</a>
						</div>
					</div>
				</div>
					...
					<div class="card card-body rounded-4 shadow-primary-lg p-4">
						<form class="row form-border-transparent g-3">
							...
							<div class="col-md-6">
								...
								<input type="email" class="form-control bg-secondary" id="floatingInput" placeholder="name@example.com">
							</div>
