...
<head>
	<title>OCTACODE Technology</title>
	<!-- Meta Tags -->
	<meta charset="utf-8">
...
<header class="header-sticky header-absolute">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			<!-- Logo START -->
			<a class="navbar-brand me-0 d-flex align-items-center" href="index.html">
...
<section class="bg-secondary position-relative pt-xl-8 overflow-hidden">
	...
	<div class="container text-center mx-auto position-relative pt-4 pt-sm-5">
		<!-- Image -->
		<img src="com_assets/images/elements/404.svg" class="h-md-400px mb-4 mb-lg-6" alt="404 image">
